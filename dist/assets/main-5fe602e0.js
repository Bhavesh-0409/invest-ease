...
const Calculator = createLucideIcon$1("Calculator", [
  [
    "rect",
...
const Navbar = /* @__PURE__ */ __name(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center h-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center space-x-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-8 w-8 text-primary-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-gray-900 dark:text-white", children: "InvestEase" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        {
          to: "/sip-calculator",
          className: `flex items-center space-x-1 px-3 py-2 rounded-md text-sm font-medium transition-colors ${location.pathname === "/sip-calculator" ? "bg-primary-100 text-primary-700 dark:bg-primary-900 dark:text-primary-300" : "text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator, { className: "h-4 w-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "SIP Calculator" })
          ]
        }
      ),
      isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-300", children: [
...
const Footer = /* @__PURE__ */ __name(() => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row justify-between items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2 mb-4 md:mb-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-6 w-6 text-primary-600" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-semibold text-gray-900 dark:text-white", children: "InvestEase" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-gray-600 dark:text-gray-400", children: "© 2024 InvestEase. All rights reserved." })
  ] }) }) });
}, "Footer");
const LandingPage = /* @__PURE__ */ __name(() => {
  const isAuthenticated = localStorage.getItem("isAuthenticated") === "true";
  const features = [
    {
    ...
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "h-8 w-8" }),
      title: "Quick Setup",
      description: "Start investing in minutes with our streamlined onboarding process."
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-gradient-to-br from-primary-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-16 w-16 text-primary-600" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6", children: [
        "Smart Investing",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-600 block", children: "Made Simple" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto", children: "Get personalized investment recommendations based on your age, risk tolerance, and financial goals. Start your investment journey with confidence." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            "Start Investing",
            /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "ml-2 h-5 w-5" })
          ]
        }
      )
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-white dark:bg-gray-900", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-gray-900 dark:text-white mb-4", children: "Why Choose InvestEase?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto", children: "We make investing accessible and straightforward for everyone, regardless of your experience level." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-8", children: features.map((feature, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-4 text-primary-600", children: feature.icon }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 dark:text-gray-300", children: feature.description })
      ] }, index2)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-primary-600", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-white mb-4", children: "Ready to Start Your Investment Journey?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-primary-100 mb-8", children: "Join thousands of smart investors who trust InvestEase" }),
...
const BackButton = /* @__PURE__ */ __name(({
  to: to2,
  label = "Back"
}) => {
...
const AuthPage = /* @__PURE__ */ __name(() => {
  ...
  const validatePhoneNumber = /* @__PURE__ */ __name((phone) => {
    const phoneRegex = /^[6-9]\d{9}$/;
    return phoneRegex.test(phone);
  }, "validatePhoneNumber");
  const handleSendOTP = /* @__PURE__ */ __name(async (e) => {
    e.preventDefault();
    setErrors({});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton, { to: "/" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-4", children: step === "phone" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-12 w-12 text-primary-600" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-12 w-12 text-primary-600" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-gray-900 dark:text-white mb-2", children: step === "phone" ? "Welcome to InvestEase" : "Verify Your Number" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 dark:text-gray-400", children: step === "phone" ? "Enter your mobile number to get started" : `We've sent a 6-digit OTP to ${phoneNumber}` })
      ] }),
      step === "phone" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSendOTP, className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "Mobile Number" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-2 text-gray-500 dark:text-gray-400", children: "+91" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "tel",
          ...
          errors.phone && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-red-600", children: errors.phone })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-sm text-gray-600 dark:text-gray-400", children: "By continuing, you agree to our Terms of Service and Privacy Policy" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleVerifyOTP, className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "Enter OTP" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
          ...
          errors.otp && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-red-600", children: errors.otp })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-yellow-800 dark:text-yellow-200", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Demo OTP:" }),
          " Use ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-yellow-200 dark:bg-yellow-800 px-1 rounded", children: "123456" }),
          " to continue"
        ] }) })
      ] })
    ] })
...
const MandatoryDetailsPage = /* @__PURE__ */ __name(() => {
  const navigate = useNavigate();
  ...
  const validateForm = /* @__PURE__ */ __name(() => {
    ...
    if (!formData.investmentAmount || parseFloat(formData.investmentAmount) < 1e3) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton, { to: "/" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900 dark:text-white mb-2", children: "Let's Get Started" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 dark:text-gray-400", children: "Tell us a few basic details to create your personalized investment plan" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "Your Age *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "number",
          ...
          errors.age && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-red-600", children: errors.age })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "Investment Amount *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-2 text-gray-500 dark:text-gray-400", children: "₹" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
          ...
          errors.investmentAmount && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-red-600", children: errors.investmentAmount })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "Risk Preference *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
            ...
            "label",
            {
              className: `cursor-pointer border-2 rounded-lg p-4 transition-colors ${formData.riskPreference === option.value ? "border-primary-500 bg-primary-50 dark:bg-primary-900/20" : "border-gray-200 dark:border-gray-700 hover:border-gray-300"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-gray-900 dark:text-white", children: option.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-gray-600 dark:text-gray-400 mt-1", children: option.desc })
                ] })
              ]
            },
            option.value
          )) }),
          errors.riskPreference && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-red-600", children: errors.riskPreference })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 pt-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: "Skip Optional Details"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
...
const OptionalInputField = /* @__PURE__ */ __name(({
  label,
  name,
  type = "text",
  value,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: label }),
    type === "select" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "select",
      {
        ...
        children: [
          ...
          options == null ? void 0 : options.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option, children: option }, option))
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      prefix && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-2 text-gray-500 dark:text-gray-400", children: prefix }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type,
...
const OptionalDetailsPage = /* @__PURE__ */ __name(() => {
  const navigate = useNavigate();
  const [formData, setFormData] = reactExports.useState({
    monthlyIncome: "",
    savings: "",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton, { to: "/details" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900 dark:text-white mb-2", children: "Additional Details" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 dark:text-gray-400", children: "Help us create a more personalized recommendation (optional)" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
...
const SummaryCard = /* @__PURE__ */ __name(({
  title,
  value,
  subtitle,
  icon,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `card ${className}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: subtitle })
    ] }),
    icon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary-600 dark:text-primary-400", children: icon })
  ] }) });
}, "SummaryCard");
/*!
 * @kurkle/color v0.3.4
...
__name(round, "round");
const lim = /* @__PURE__ */ __name((v, l2, h) => Math.max(Math.min(v, h), l2), "lim");
function p2b(v) {
...
const alpha = /* @__PURE__ */ __name((a, f2) => a < 255 ? f2(a) : "", "alpha");
...
function hsl2rgbn(h, s, l2) {
  ...
  const f2 = /* @__PURE__ */ __name((n2, k2 = (n2 + h / 30) % 12) => l2 - a * Math.max(Math.min(k2 - 3, 9 - k2, 1), -1), "f");
  return [f2(0), f2(8), f2(4)];
}
__name(hsl2rgbn, "hsl2rgbn");
function hsv2rgbn(h, s, v) {
  const f2 = /* @__PURE__ */ __name((n2, k2 = (n2 + h / 60) % 6) => v - v * s * Math.max(Math.min(k2, 4 - k2, 1), 0), "f");
...
function hslString(v) {
  ...
  const s = n2p(a[1]);
  const l2 = n2p(a[2]);
  return v.a < 255 ? `hsla(${h}, ${s}%, ${l2}%, ${b2n(v.a)})` : `hsl(${h}, ${s}%, ${l2}%)`;
}
...
const elasticIn = /* @__PURE__ */ __name((t, s, p2) => -(Math.pow(2, 10 * (t -= 1)) * Math.sin((t - s) * TAU / p2)), "elasticIn");
const elasticOut = /* @__PURE__ */ __name((t, s, p2) => Math.pow(2, -10 * t) * Math.sin((t - s) * TAU / p2) + 1, "elasticOut");
const effects = {
  linear: (t) => t,
  easeInQuad: (t) => t * t,
  easeOutQuad: (t) => -t * (t - 2),
...
const getComputedStyle = /* @__PURE__ */ __name((element) => element.ownerDocument.defaultView.getComputedStyle(element, null), "getComputedStyle");
...
}, __name(_a, "Chart"), __publicField(_a, "defaults", defaults), __publicField(_a, "instances", instances), __publicField(_a, "overrides", overrides), __publicField(_a, "registry", registry), __publicField(_a, "version", version), __publicField(_a, "getChart", getChart), _a);
...
const changeExponent = /* @__PURE__ */ __name((v, m2) => Math.pow(10, log10Floor(v) + m2), "changeExponent");
...
const AllocationDonutChart = /* @__PURE__ */ __name(({ data }) => {
  const chartData = {
    labels: data.labels,
    datasets: [
      {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-80", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Doughnut, { data: chartData, options }) });
...
const SIPLineGraph = /* @__PURE__ */ __name(({ data }) => {
  const chartData = {
    labels: data.labels,
    datasets: [
      {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-80", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { data: chartData, options }) });
}, "SIPLineGraph");
const RecommendationPage = /* @__PURE__ */ __name(() => {
  const navigate = useNavigate();
  const [userDetails, setUserDetails] = reactExports.useState(null);
  reactExports.useEffect(() => {
  ...
  const getDummyRecommendation = /* @__PURE__ */ __name(() => {
    if (!userDetails)
      return null;
  ...
  const sipData = {
    ...
    invested: [12e3, 24e3, 36e3, 48e3, 6e4],
    returns: [13e3, 27500, 43200, 60800, 81500]
  };
  const handleDownloadPDF = /* @__PURE__ */ __name(async () => {
    try {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton, { to: "/optional" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900 dark:text-white mb-2", children: "Your Personalized Investment Plan" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600 dark:text-gray-400", children: [
        "Based on your ",
        userDetails.riskPreference.toLowerCase(),
        " risk preference and ₹",
        parseInt(userDetails.investmentAmount).toLocaleString(),
        " investment"
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-8 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-gray-900 dark:text-white mb-4", children: "Recommended Asset Allocation" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AllocationDonutChart, { data: recommendation.allocation })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-gray-900 dark:text-white mb-4", children: "SIP Growth Projection" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SIPLineGraph, { data: sipData })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-gray-900 dark:text-white mb-4", children: "Investment Strategy Explained" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-700 dark:text-gray-300 leading-relaxed mb-6", children: recommendation.explanation }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-3", children: "Key Benefits of This Plan:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-4", children: recommendation.features.map((feature, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 bg-primary-600 rounded-full" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700 dark:text-gray-300", children: feature })
      ] }, index2)) })
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Compare Plans" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Download Report" })
          ]
        }
      )
    ] })
...
const ComparePlansToggle = /* @__PURE__ */ __name(({
  activeView,
  onViewChange
}) => {
  const views = [
    { key: "table", label: "Table", icon: Table },
    { key: "card", label: "Cards", icon: BarChart3 },
    { key: "graph", label: "Graph", icon: TrendingUp }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex bg-gray-100 dark:bg-gray-800 rounded-lg p-1", children: views.map(({ key, label, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      onClick: () => onViewChange(key),
      className: `flex items-center space-x-2 px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeView === key ? "bg-white dark:bg-gray-700 text-primary-600 dark:text-primary-400 shadow-sm" : "text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"}`,
      children: [
...
const ComparePlansTable = /* @__PURE__ */ __name(({ plans }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "min-w-full divide-y divide-gray-200 dark:divide-gray-700", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-gray-50 dark:bg-gray-800", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider", children: "Plan" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider", children: "Risk Level" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider", children: "Expected Return" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider", children: "Min Investment" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider", children: "Lock-in Period" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider", children: "Tax Benefit" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700", children: plans.map((plan, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-gray-50 dark:hover:bg-gray-800", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white", children: plan.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400", children: plan.risk }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400", children: plan.expectedReturn }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400", children: plan.minInvestment }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400", children: plan.lockIn }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400", children: plan.taxBenefit })
    ] }, index2)) })
  ] }) });
}, "ComparePlansTable");
const PlanCard = /* @__PURE__ */ __name(({
  title,
  risk,
  expectedReturn,
  features,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `card cursor-pointer transition-all duration-200 hover:shadow-md ${recommended ? "ring-2 ring-primary-500 bg-primary-50 dark:bg-primary-900/20" : ""}`,
      onClick,
      children: [
        recommended && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary-600 text-white text-xs font-medium px-3 py-1 rounded-full inline-block mb-4", children: "Recommended" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-gray-900 dark:text-white mb-2", children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: "Risk Level" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-900 dark:text-white", children: risk })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: "Expected Return" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-primary-600 dark:text-primary-400", children: expectedReturn })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: features.map((feature, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center space-x-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-4 w-4 text-green-500" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-700 dark:text-gray-300", children: feature })
        ] }, index2)) })
      ]
    }
  );
}, "PlanCard");
const ComparePlansPage = /* @__PURE__ */ __name(() => {
  const [activeView, setActiveView] = reactExports.useState("card");
  const plans = [
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton, { to: "/recommendation" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900 dark:text-white mb-2", children: "Compare Investment Plans" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 dark:text-gray-400", children: "Choose the plan that best fits your investment goals" })
    ] }),
    ...
    activeView === "card" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: plans.map((plan, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      PlanCard,
      {
        title: plan.name,
        risk: plan.risk,
        ...
        recommended: index2 === 1
      },
      index2
    )) }),
    activeView === "table" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ComparePlansTable, { plans }) }),
    activeView === "graph" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-gray-900 dark:text-white mb-4", children: "Growth Comparison (5 Years)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SIPLineGraph, { data: comparisonData })
    ] })
  ] }) });
}, "ComparePlansPage");
const SIPCalculatorPage = /* @__PURE__ */ __name(() => {
  const [formData, setFormData] = reactExports.useState({
    monthlyAmount: "5000",
    expectedReturn: "12",
    timePeriod: "10"
  ...
  const calculateSIP = /* @__PURE__ */ __name(() => {
  ...
  const generateChartData = /* @__PURE__ */ __name(() => {
  ...
  const handleCalculate = /* @__PURE__ */ __name(async () => {
    try {
      const response = await fetch("https://builder.empromptu.ai/api_tools/database/query", {
        method: "POST",
        headers: {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BackButton, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator, { className: "h-12 w-12 text-primary-600" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900 dark:text-white mb-2", children: "SIP Calculator" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 dark:text-gray-400", children: "Calculate your systematic investment plan returns" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-gray-900 dark:text-white mb-6", children: "Investment Details" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "Monthly SIP Amount" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-2 text-gray-500 dark:text-gray-400", children: "₹" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "Expected Annual Return" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-3 top-2 text-gray-500 dark:text-gray-400", children: "%" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "Investment Period" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-3 top-2 text-gray-500 dark:text-gray-400", children: "years" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SummaryCard,
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card mt-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-gray-900 dark:text-white mb-4", children: "Investment Growth Over Time" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SIPLineGraph, { data: chartData })
    ] })
  ] }) });
}, "SIPCalculatorPage");
const NotFoundPage = /* @__PURE__ */ __name(() => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-16 w-16 text-primary-600" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-6xl font-bold text-gray-900 dark:text-white mb-4", children: "404" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto", children: "The page you're looking for doesn't exist. Let's get you back to investing!" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        to: "/",
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/details", element: /* @__PURE__ */ jsxRuntimeExports.jsx(MandatoryDetailsPage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/optional", element: /* @__PURE__ */ jsxRuntimeExports.jsx(OptionalDetailsPage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/recommendation", element: /* @__PURE__ */ jsxRuntimeExports.jsx(RecommendationPage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/compare", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ComparePlansPage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/sip-calculator", element: /* @__PURE__ */ jsxRuntimeExports.jsx(SIPCalculatorPage, {}) }),
